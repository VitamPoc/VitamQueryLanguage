...
public class SetAction extends Action {
     ...
     * @throws InvalidCreateOperationException
     */
    public final SetAction addSetAction(final String variableName, final String value) throws InvalidCreateOperationException {
     ...
     * @throws InvalidCreateOperationException
     */
    public final SetAction addSetAction(final String variableName, final boolean value) throws InvalidCreateOperationException {
        if (currentUPDATE != UPDATE.set) {
            throw new InvalidCreateOperationException("Cannot add a set element since this is not a Set Action: " + currentUPDATE);
        }
        if (variableName == null || variableName.trim().isEmpty()) {
     ...
     * @throws InvalidCreateOperationException
     */
    public final SetAction addSetAction(final String variableName, final long value) throws InvalidCreateOperationException {
        if (currentUPDATE != UPDATE.set) {
            throw new InvalidCreateOperationException("Cannot add a set element since this is not a Set Action: " + currentUPDATE);
        }
        if (variableName == null || variableName.trim().isEmpty()) {
     ...
     * @throws InvalidCreateOperationException
     */
    public final SetAction addSetAction(final String variableName, final double value) throws InvalidCreateOperationException {
        if (currentUPDATE != UPDATE.set) {
            throw new InvalidCreateOperationException("Cannot add a set element since this is not a Set Action: " + currentUPDATE);
        }
        if (variableName == null || variableName.trim().isEmpty()) {
