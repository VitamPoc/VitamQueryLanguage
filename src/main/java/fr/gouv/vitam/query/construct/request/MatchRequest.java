...
public class MatchRequest extends Request {
     ...
     */
    public MatchRequest(final REQUEST matchRequest, final String variableName, final String value)
            throws InvalidCreateOperationException {
        super();
        switch (matchRequest) {
            case match:
     ...
     * @throws InvalidCreateOperationException
     */
    public final MatchRequest setMatchMaxExpansions(final int max) throws InvalidCreateOperationException {
