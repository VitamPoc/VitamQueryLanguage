...
public class BooleanRequest extends Request {
     ...
     */
    public BooleanRequest(final REQUEST booleanRequest) throws InvalidCreateOperationException {
        super();
        ...
        if (currentREQUEST != null) {
            switch (currentREQUEST) {
                ...
                case or:
                    break;
                default:
                    throw new InvalidCreateOperationException("Requests cannot be added since this is not a boolean query: "
                            + currentREQUEST);
            }
        }
