...
public class UnsetAction extends Action {
     ...
     * @throws InvalidCreateOperationException
     */
    public final UnsetAction addUnSetAction(final String... variableNames) throws InvalidCreateOperationException {
        if (currentUPDATE != UPDATE.unset) {
            throw new InvalidCreateOperationException("Cannot add an unset element since this is not a UnSet Action: "
                    + currentUPDATE);
        }
