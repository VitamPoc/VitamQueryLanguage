 ...
 *
 */
public class ResultCouchbase extends ResultAbstract {
    private static final VitamLogger LOGGER = VitamLoggerFactory.getInstance(ResultCouchbase.class);
     ...
     * @param collection
     */
    public ResultCouchbase(final Collection<String> collection) {
    ...
    */
    ...
    public void putFrom(final ResultInterface from) {
        node = ((ResultCouchbase) from).node.deepCopy();
        loaded = true;
        getAfterLoad();
    }
    ...
    public void save(final MongoDbAccess dbvitam) {
        ...
        dbvitam.cba.setToId(id, node, GlobalDatas.TTL);
        loaded = true;
    }
    /**
    ...
    public void updateTtl(final MongoDbAccess dbvitam) {
        ...
        dbvitam.cba.updateTtl(id, GlobalDatas.TTL);
    }
}
