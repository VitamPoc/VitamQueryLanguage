...
public class SAip extends VitamType {
     ...
     */
    public static SAip findOne(final CassandraAccess dbvitam, final String refid) throws InstantiationException,
    ...
    protected static void addIndexes(final CassandraAccess dbvitam) {
        dbvitam.saips.createIndex(CassandraAccess.VitamLinks.PAip2SAip.field2to1);
    }
    protected static String createTable() {
        return ", "+CassandraAccess.VitamLinks.PAip2SAip.field2to1+ " varchar";
    }
