...
public class DuaRef extends VitamType {
     ...
     */
    public static DuaRef findOne(final CassandraAccess dbvitam, final String refid) throws InstantiationException,
            IllegalAccessException {
        return (DuaRef) dbvitam.findOne(Cdua, refid);
    }

    protected static DuaRef loadFromResultSetRow(Row row) {
        row.
    }
