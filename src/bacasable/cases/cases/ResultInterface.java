...
public interface ResultInterface {
     ...
     * @param id
     */
    public void setId(final CassandraAccess dbvitam, final String id);
    /**
    *
    * @return the ID
    */
    ...
    */
   public void updateLoadMinMax(final CassandraAccess dbvitam) throws InstantiationException, IllegalAccessException;
   /**
    * @param mdAccess
    ...
    * @throws IllegalAccessException
    */
   public boolean checkAncestor(final CassandraAccess mdAccess, final ResultInterface next) throws InstantiationException,
