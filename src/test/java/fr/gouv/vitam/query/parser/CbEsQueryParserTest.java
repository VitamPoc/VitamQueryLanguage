...
import static fr.gouv.vitam.query.construct.RequestHelper.flt;
...
import static fr.gouv.vitam.query.construct.RequestHelper.match;
import static fr.gouv.vitam.query.construct.RequestHelper.matchPhrase;
import static fr.gouv.vitam.query.construct.RequestHelper.matchPhrasePrefix;
...
import static fr.gouv.vitam.query.construct.RequestHelper.or;
...
public class CbEsQueryParserTest {
    ...
    public void testParse() {
        try {
            final CbEsQueryParser command1 = new CbEsQueryParser(true);
            ...
            query.addRequests(matchPhrasePrefix("mavar11", "ceci est une phrase").setMatchMaxExpansions(10)
            ...
            final CbEsQueryParser command = new CbEsQueryParser(true);
